 ...
 * @author maiko
 */
public class JavaDB操作8 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            db8 = DriverManager.getConnection("jdbc:mysql://localhost:3306/Challenge_db", "maiko.saito", "muginoumi");
            
            
            String n = request.getParameter("textname");
            
            ps1 = db8.prepareStatement("select * from profiles where name like ?");
            ps1.setString(1, "%"+n+"%");
