...
public class InsertResult extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            /* hs.getAttribute("ac") = insert.java で生成されたオブジェクト
            ...
            int iYear = Integer.parseInt(udb.getYear());
            int iMonth = Integer.parseInt(udb.getMonth());
            int iDay = Integer.parseInt(udb.getDay());
            //月だけ0～11なので処理
            int iMonth2 = iMonth-1;
            
            birthday.set(iYear, iMonth2, iDay);
